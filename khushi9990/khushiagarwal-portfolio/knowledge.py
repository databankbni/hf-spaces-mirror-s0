...
# 👋 GREETINGS ======================================================
  
  {
    "id": "hello",
    "category": "greeting",
    "keywords": ["hi", "hello", "hey", "hii", "heyy", "namaste","good morning","good afternoon","good evening","yo","sup","hola","bonjour"],
    "message":
...
#👩 ABOUT KHUSHI ======================================================
  {
    ...
    "message":
      "Khushi Agarwal is a Computer Science undergraduate passionate about AI, Machine Learning, Data Science, and modern web technologies. She enjoys building practical AI applications that solve real-world problems while continuously exploring new technologies.",
    "messages": [
      "Khushi Agarwal is passionate CS student and a AI/ML enthusiast who builds practical AI projects using modern web technologies.",
  ...
  },
{
  ...
  },
  {
    ...
    "message":
        "Khushi's goal is to become an AI Engineer who builds intelligent products that solve real-world problems. She enjoys learning, experimenting, and continuously improving her skills.",
    "messages": [
        "Her long-term goal is to build impactful AI products that people genuinely enjoy using.",
        "Khushi wants to combine AI, data, and software engineering to create meaningful solutions."
    ],
    "action": None,
},
{
    ...
    "message":
        "Right now, Khushi is exploring Large Language Models (LLMs), Retrieval-Augmented Generation (RAG), FastAPI, and advanced AI application development while continuously improving her data science and machine learning skills.",
    "messages": [
        "She's currently focused on LLMs, RAG systems, AI engineering, and building production-ready applications.",
        "Learning never stops! Khushi is always experimenting with new AI technologies."
    ],
    "action": None,
},
{
    ...
    "message":
        "One of Khushi's biggest challenges has been turning AI ideas into complete products with frontend, backend, and deployment. Every project has helped her improve her problem-solving and engineering skills.",
    "messages": [
        "Building complete AI applications has taught Khushi much more than simply training machine learning models.",
        "Every project brought new challenges, from debugging to deployment—and that's where the real learning happened."
    ],
    "action": None,
},
  ...
  },
{
    ...
    "category": "project",
    "keywords": ["portfolio", "this website", "your portfolio", "website", "personal website","how you build zoyi","zoyi build","portfolio build"],
    "message":
      "You're exploring it right now! 😄 This portfolio isn't just a website—it's an interactive experience built by Khushi to showcase her AI projects, technical skills, creativity, and problem-solving abilities. And of course... that's where I come in!.This is build using built using React, TypeScript, FastAPI. ✨",
    "messages": [
      "You're exploring it right now! 😄 This portfolio isn't just a website—it's an interactive experience built by Khushi to showcase her AI projects, technical skills, creativity, and problem-solving abilities. And of course... that's where I come in!.This is build using built using React, TypeScript, FastAPI. ✨",
      "This portfolio is Khushi’s digital space to show her projects, skills, creativity, and AI journey.This is build using built using React, TypeScript, FastAPI.",
      "This website is more than a portfolio — it’s a little AI-powered experience, starring me of course.This is build using built using React, TypeScript, FastAPI. 😄",
    ],
    "action": "projects",
  },
  {
    ...
    "message":
        "This portfolio is built with React, TypeScript, Tailwind CSS, FastAPI, and Supabase. It also includes me—Zoyi, a custom AI assistant with voice support and intelligent navigation.",
    "messages": [
        "React + TypeScript + Tailwind for the frontend, FastAPI for the backend, and Supabase for data management.",
        "Khushi built this portfolio as a full-stack AI application rather than just a static website."
    ],
    "action": None,
},
  {
...
"scanit ai",
"resume screener",
"resume screening ai","Scanit-AI", "resume ai", "resume screening", "candidate", "hiring", "recruitment"],
    "message":
...
# 🤖 ZOYI ======================================================{
    {"id": "zoyi-name",
    "category": "zoyi",
    "keywords": ["tell me about zoyi","how were you built","about zoyi","your name", "who are you", "what is your name", "zoyi", "introduce yourself","who built you","how do you work"],
    "message":
  ...
  },
{
    ...
    "message":
        "Unlike a traditional portfolio, this one is interactive. Visitors can explore projects through me, listen to voice responses, navigate instantly, and learn about Khushi in a conversational way.",
    "messages": [
        "This isn't just a website—it's an AI-powered experience.",
        "Khushi wanted recruiters to interact with her work instead of simply scrolling through it."
    ],
    "action": None,
},
  #FunFact-----------------------------------------
...
def get_agent_response(input_text: str) -> AgentResponse:
    question = re.sub(r"[^\w\s]", "", input_text.lower()).strip()
    ...
    if scored_chunks:
        if scored_chunks:
            highest_score = scored_chunks[0]["score"]

            best_chunks = [
                chunk for chunk in scored_chunks
                if chunk["score"] == highest_score
    ]
            best_match = random.choice(best_chunks)
            return {
