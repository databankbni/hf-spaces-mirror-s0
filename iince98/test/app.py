    ...
    for card in soup.find_all('article')[:2]:
        ...
        if product_link:
            try:
                ...
                details_section = ps.find('section', class_="flex gap-8 flex-wrap mb-24")
...
def evaluate_listing_with_claude(raw_text, details, price, product_name=""):
    ...
    prompt = f"""
        You are evaluating whether this second-hand item is worth buying.
        ...
        Determine whether this is a good purchase considering:
