"""Supabase JWT verifier — canonical implementation for the identity context.

The former ``app.auth.supabase_auth`` back-compat shim was removed in GRO-100
(CP16b); all callers import from here directly.
"""
...
class AuthNotConfiguredError(RuntimeError):
    """Raised when JWT verification settings are intentionally not configured."""
