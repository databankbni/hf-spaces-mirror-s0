...
class Settings(BaseSettings):
    ...
    enable_ingestion_studio: bool = False
    # GRO-225 / S5b — structural owning-node augmentation (off until measured in eval/prod).
    enable_structural_augmentation: bool = False
