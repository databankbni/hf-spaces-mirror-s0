...
from app.ingestion.domain.models import Chunk, IngestionWarning, ParsedDocument
...
class IngestionReport(BaseModel):
    ...
    sections_by_source: dict[str, int] = Field(default_factory=dict)
...
def build_report(
    *,
    ...
    return IngestionReport(
        ...
        sections_by_source={document.source.source_id: len(document.sections) for document in documents},
