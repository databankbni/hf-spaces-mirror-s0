...
CANONICALIZATION_VERSION = "v192_15"
RELATIONSHIP_TABLE_VERSION = "v192_15"
    ...
    *,
    ...
    if strong != UNKNOWN and meta["energy_type"] != strong:
        ...
        return {
            **meta,
            "energy_type": strong,
            "energy_normalization_source": "V192_15_TEXT_OVERRIDES_RAW_FIELD",
...
def add_v192_15_semantic_columns(frame: pd.DataFrame) -> pd.DataFrame:
    result = frame.copy()
    ...
    result["condition_source_v192_15"] = condition["condition_source_v192_13"]
    result["condition_risk_level_v192_15"] = condition["condition_risk_level_v192_13"]
    return result
