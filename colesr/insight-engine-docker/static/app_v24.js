...
// Great-circle arc interpolation — creates points along the shortest path on sphere surface
function greatCirclePoints(lat1, lon1, lat2, lon2, radius, segments) {
  ...
  for (let i = 0; i <= segments; i++) {
    ...
    const dot = p1.dot(p2) / (radius * radius);
    ...
    pts.push(new THREE.Vector3(x, y, z).normalize().multiplyScalar(radius));
  }
  return pts;
}

// Draw a thin lat/lon grid for geographic reference
function drawGlobeGrid(radius) {
  const gridMat = new THREE.LineBasicMaterial({ color: 0x1e3a5f, transparent: true, opacity: 0.25, depthTest: true });
  const equatorMat = new THREE.LineBasicMaterial({ color: 0x22d3ee, transparent: true, opacity: 0.35, depthTest: true });
  const primeMat = new THREE.LineBasicMaterial({ color: 0x22d3ee, transparent: true, opacity: 0.25, depthTest: true });

  // Meridians (great circles through poles)
...
function drawCountryBoundaries(radius) {
  // === REAL CONTINENTAL COASTLINES ===
  // Each chain traces an actual coastline in correct geographic order.
  // Points are [lat, lon]. Great-circle arcs connect them.

  const coastlines = [
    // === NORTH AMERICA (Pacific→Mexico→Gulf→Atlantic→Arctic) ===
    [
      [71.3, -156], [70, -161], [68, -166], [66, -170], [64, -173], [60, -166], [58, -136],
      [56, -135], [54, -133], [52, -128], [49, -125], [47, -124], [45, -124], [43, -125],
      [41, -125], [39, -124], [37, -122], [35, -121], [33, -118], [32, -117], [31, -116],
      [29, -114], [27, -114], [25, -112], [23, -110], [21, -106], [19, -105], [17, -100],
      [15, -97], [14, -93], [15, -88], [18, -88], [20, -87], [22, -84], [24, -81],
      [25, -80], [26, -80], [27, -80], [28, -80], [29, -80], [30, -81], [31, -81],
      [32, -81], [33, -79], [34, -77], [35, -76], [36, -76], [37, -76], [38, -75],
      [39, -74], [40, -74], [41, -72], [42, -70], [43, -70], [44, -68], [45, -61],
      [46, -55], [47, -54], [48, -55], [49, -57], [50, -57], [51, -57], [52, -56],
      [53, -56], [54, -58], [55, -60], [56, -62], [57, -64], [58, -66], [59, -68],
      [60, -70], [61, -72], [62, -74], [63, -76], [64, -78], [65, -80], [66, -82],
      [67, -84], [68, -92], [69, -100], [70, -130], [71.3, -156]
    ],

    // === SOUTH AMERICA (Caribbean→Brazil→Argentina→Chile→Ecuador→Colombia) ===
    [
      [12, -72], [11, -74], [10, -75], [9, -76], [8, -77], [7, -77], [6, -78],
      [5, -78], [4, -79], [3, -80], [2, -80], [1, -81], [0, -80], [-1, -81],
      [-2, -80], [-3, -80], [-4, -80], [-5, -80], [-6, -80], [-7, -80], [-8, -80],
      [-9, -80], [-10, -80], [-11, -80], [-12, -80], [-13, -80], [-14, -80],
      [-15, -80], [-16, -80], [-17, -80], [-18, -80], [-19, -80], [-20, -80],
      [-21, -80], [-22, -80], [-23, -80], [-24, -80], [-25, -80], [-26, -80],
      [-27, -80], [-28, -80], [-29, -80], [-30, -80], [-31, -80], [-32, -80],
      [-33, -80], [-34, -80], [-35, -80], [-36, -80], [-37, -80], [-38, -80],
      [-39, -80], [-40, -73], [-41, -73], [-42, -73], [-43, -73], [-44, -74],
      [-45, -74], [-46, -74], [-47, -74], [-48, -74], [-49, -74], [-50, -74],
      [-51, -74], [-52, -74], [-53, -74], [-54, -74], [-55, -68], [-55, -66],
      [-55, -64], [-54, -68], [-53, -70], [-52, -70], [-51, -70], [-50, -70],
      [-49, -70], [-48, -70], [-47, -70], [-46, -70], [-45, -70], [-44, -70],
      [-43, -70], [-42, -70], [-41, -70], [-40, -70], [-39, -70], [-38, -70],
      [-37, -70], [-36, -70], [-35, -70], [-34, -70], [-33, -70], [-32, -70],
      [-31, -70], [-30, -70], [-29, -70], [-28, -70], [-27, -70], [-26, -70],
      [-25, -70], [-24, -70], [-23, -70], [-22, -70], [-21, -70], [-20, -70],
      [-19, -70], [-18, -70], [-17, -70], [-16, -70], [-15, -70], [-14, -70],
      [-13, -70], [-12, -70], [-11, -70], [-10, -70], [-9, -70], [-8, -70],
      [-7, -70], [-6, -70], [-5, -70], [-4, -70], [-3, -70], [-2, -70],
      [-1, -70], [0, -70], [1, -70], [2, -70], [3, -70], [4, -70],
      [5, -70], [6, -70], [7, -70], [8, -70], [9, -70], [10, -72],
      [11, -73], [12, -72]
    ],

    // === EUROPE (Atlantic→North Sea→Baltic→Black Sea→Mediterranean) ===
    [
      [36, -6], [36, -10], [37, -10], [38, -10], [39, -10], [40, -10], [41, -10],
      [42, -10], [43, -10], [44, -2], [45, 0], [46, 2], [47, 3], [48, 5],
      [49, 7], [50, 10], [51, 11], [52, 12], [53, 13], [54, 14], [55, 16],
      [56, 17], [57, 19], [58, 21], [59, 23], [60, 25], [61, 27], [62, 28],
      [63, 30], [64, 32], [65, 34], [66, 36], [67, 38], [68, 40], [69, 42],
      [70, 44], [71, 30], [72, 20], [71, 10], [70, 0], [69, -10], [68, -20],
      [67, -25], [65, -25], [63, -26], [61, -26], [59, -26], [57, -26],
      [55, -26], [53, -26], [51, -26], [49, -26], [47, -26], [45, -26],
      [43, -26], [41, -26], [39, -26], [37, -26], [36, -6]
    ],

    // === AFRICA (full ring: Mediterranean→Atlantic→Southern→Indian→Red Sea) ===
    [
      [36, -6], [36, -10], [35, -10], [34, -10], [33, -10], [32, -10],
      [31, -10], [30, -10], [29, -10], [28, -12], [27, -14], [26, -16],
      [25, -17], [24, -17], [23, -17], [22, -17], [21, -17], [20, -17],
      [19, -17], [18, -17], [17, -17], [16, -17], [15, -17], [14, -17],
      [13, -17], [12, -17], [11, -17], [10, -17], [9, -17], [8, -17],
      [7, -17], [6, -17], [5, -16], [4, -16], [3, -16], [2, -16],
      [1, -16], [0, -16], [-1, -14], [-2, -12], [-3, -12], [-4, -12],
      ...
      [-31, -12], [-32, -12], [-33, -12], [-34, -12], [-35, -18],
      [-35, -20], [-35, -22], [-35, -24], [-35, -26], [-35, -28],
      [66, -42], [65, -44], [64, -46], [63, -48], [62, -50], [61, -52],
      [60, -54], [60, -56], [60, -58], [60, -60], [61, -62], [62, -64],
      [63, -66], [64, -68], [65, -70], [66, -72], [67, -74], [68, -76],
      [69, -74], [70, -72], [71, -70], [72, -68], [73, -66], [74, -64],
      [75, -62], [76, -60], [77, -58], [78, -56], [79, -54], [80, -52],
      [81, -50], [82, -48], [83, -46], [84, -44], [84, -30]
    ],

    // === ANTARCTICA (outer ring) ===
    [
      [-65, -180], [-65, -150], [-65, -120], [-65, -90], [-65, -60],
      [-65, -30], [-65, 0], [-65, 30], [-65, 60], [-65, 90],
      [-65, 120], [-65, 150], [-65, 180]
    ],

    // === JAPAN (Honshu+Kyushu+Hokkaido arc) ===
    [
      [46, 143], [45, 142], [44, 142], [43, 144], [42, 144], [41, 141],
      [40, 140], [39, 140], [38, 141], [37, 141], [36, 140], [35, 140],
      [34, 137], [33, 132], [32, 131], [31, 131], [30, 130], [31, 131],
      [32, 133], [33, 136], [34, 138], [35, 140], [36, 142], [37, 143],
      [38, 144], [39, 145], [40, 146], [41, 147], [42, 147], [43, 147],
      [44, 147], [45, 147], [46, 143]
    ],

    // === UK + IRELAND ===
    [
      [51, -5], [52, -5], [53, -4], [54, -3], [55, -2], [56, -2],
      [57, -2], [58, -3], [59, -4], [60, -4], [61, -5], [60, -7],
      [59, -8], [58, -8], [57, -8], [56, -8], [55, -7], [54, -6],
      [53, -6], [52, -6], [51, -6], [50, -5], [49, -5], [48, -5],
      [47, -5], [46, -5], [45, -5], [44, -5], [43, -5], [42, -5],
      [41, -5], [40, -5], [39, -5], [38, -5], [37, -5], [36, -5],
      [35, -5], [34, -5], [33, -5], [32, -5], [31, -5], [30, -5],
      [51, -5]
    ],

    // === INDONESIA / MALAYSIA archipelago (major islands) ===
    [
      [6, 95], [5, 96], [4, 97], [3, 98], [2, 99], [1, 100],
      [0, 101], [-1, 102], [-2, 103], [-3, 104], [-4, 105], [-5, 106],
      [-6, 107], [-7, 108], [-8, 109], [-9, 110], [-10, 112],
      [-11, 120], [-8, 130], [-5, 140], [0, 142], [3, 118],
      [5, 108], [6, 100], [6, 95]
    ],
  ];

  // Bright cyan-blue material, depthTest=true for realistic occlusion
  const mat = new THREE.LineBasicMaterial({
    color: 0x7dd3fc, transparent: true, opacity: 0.6, depthTest: true
  });
  ...
  coastlines.forEach(chain => {
    ...
    for (let i = 0; i < chain.length - 1; i++) {
      const seg = greatCirclePoints(chain[i][0], chain[i][1], chain[i+1][0], chain[i+1][1], radius, 8);
      allPts.push(...seg);
    }
    // Close loop if start ≈ end
    const first = chain[0], last = chain[chain.length - 1];
    if (Math.abs(first[0]-last[0]) < 3 && Math.abs(first[1]-last[1]) < 3) {
      const seg = greatCirclePoints(last[0], last[1], first[0], first[1], radius, 8);
      allPts.push(...seg);
    }
