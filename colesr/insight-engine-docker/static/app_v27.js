...
function drawGlobeGrid(radius) {
  const gridMat = new THREE.LineBasicMaterial({ color: 0x1e3a5f, transparent: true, opacity: 0.2, depthTest: true });
  const equatorMat = new THREE.LineBasicMaterial({ color: 0x22d3ee, transparent: true, opacity: 0.3, depthTest: true });
  const primeMat = new THREE.LineBasicMaterial({ color: 0x22d3ee, transparent: true, opacity: 0.2, depthTest: true });
...
function drawCountryBoundaries(radius) {
  // Verified geographic anchor points. Linear interpolation + sphere projection = correct paths.
  const coastlines = [
    // === NORTH AMERICA ===
    [ [71,-156],[60,-166],[55,-130],[49,-123],[37,-122],[25,-112],[25,-80],[36,-76],[41,-74],[47,-53],[55,-60],[66,-85],[71,-156] ],
...
function initGlobe() {
  ...
  // Rotate so Americas face front (default camera sees 90°E; rotate 180° to show 90°W / Americas)
