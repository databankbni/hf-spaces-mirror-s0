...
function drawCountryBoundaries(radius) {
  // Simplified continental / major country boundary outlines
  // These are rough point-to-point chains of lat/lon for major land borders
  const boundaries = [
    // North America — USA-Canada western
    [[49, -125], [49, -120], [49, -115], [49, -110], [49, -105], [49, -100], [49, -95], [49, -90], [49, -85], [49, -80], [47.5, -80], [45, -80], [43.6, -79.4], [43, -79], [42.9, -78.9], [43, -73.5], [45, -73.5], [45, -70]],
    // USA-Canada Great Lakes area
    [[48, -89.5], [47.5, -89.5], [47, -88.5], [46.5, -84.5], [46, -84], [45, -83], [43.6, -82.4], [42.3, -83]],
    // USA-Mexico
    [[32.5, -117], [32.5, -114], [31.3, -111], [31, -106.5], [29.3, -103], [29, -100.5], [26, -97.5], [25.9, -97.4], [25.8, -97.3]],
    // South America — Brazil borders (simplified)
    [[5.2, -60], [4, -58], [1, -53], [-4, -52], [-10, -52], [-15, -57], [-19, -57], [-23, -55], [-25, -53.5], [-30, -53.5], [-33, -53]],
    // Brazil-Argentina-Uruguay
    [[-30, -57], [-32, -58], [-34, -58]],
    // Chile-Peru-Bolivia-Argentina western spine
    [[-18, -70.5], [-20, -70], [-22, -68.5], [-24, -67.5], [-27, -68], [-30, -70], [-33, -70], [-37, -73], [-41, -73], [-45, -73], [-50, -73], [-52, -69], [-55, -67.5]],
    // Argentina-Uruguay-Brazil southern
    [[-30, -58], [-32, -58], [-34, -58], [-34, -53.5]],
    // Europe — UK rough outline
    [[51, -5.7], [52, -4.5], [53.5, -3.5], [54.5, -3.2], [55.8, -2], [57.5, -4], [58.5, -3.5], [59, -2.5], [58.5, -1.5], [57.7, -2], [56.8, -2.5], [56, -3], [55.5, -2], [54.9, -1.5], [54, -1], [53.3, 0], [52.6, 1.3], [51.8, 1.3], [51.1, 0.9], [50.8, -0.3], [50.7, -1.5], [50.8, -2.5], [51, -4], [51.2, -5], [51, -5.7]],
    // France borders
    [[51, 2.3], [50.8, 1.7], [50.3, 1.6], [49.5, 1], [49, 1], [48.5, 2.5], [48, 3.5], [47.5, 4], [47, 5.5], [46.2, 6], [46.2, 6.8], [45.8, 6.5], [45, 6.5], [43.7, 7.6], [43.5, 7.4], [42.5, 3], [42.3, 3], [42.5, 2], [43, 1], [43.3, 0.5], [43.4, -1.8], [43.5, -1.5], [43.6, 1.2], [44.5, 1.3], [45, 1.3], [45.5, 1.4], [46.3, 1.1], [47, 1], [47.5, 0.5], [48, 0.5], [48.5, 0.5], [49, 1.3], [49.5, 1.5], [50, 2], [50.5, 2.3], [51, 2.3]],
    // Germany borders
    [[45.5, 141], [45, 142], [44.5, 143], [44, 144], [43.5, 145], [43, 145.5], [42.5, 146], [42, 146.5], [41.5, 147], [41, 147.5], [40.5, 148], [40, 148.5], [39.5, 149], [39, 149.5], [38.5, 150], [38, 150.5], [37.5, 151], [37, 151.5], [36.5, 152], [36, 152.5], [35.5, 153], [35, 153.5], [34.5, 154], [34, 154.5], [33.5, 155], [33, 155.5], [32.5, 156], [32, 156.5], [31.5, 157], [31, 157.5], [30.5, 158], [30, 158.5], [29.5, 159], [29, 159.5], [28.5, 160], [28, 160.5], [27.5, 161], [27, 161.5], [26.5, 162], [26, 162.5]],
    // Asia — Australia
    [[-11, 142], [-12, 143], [-13, 144], [-14, 145], [-15, 146], [-16, 147], [-17, 148], [-18, 149], [-19, 150], [-20, 151], [-21, 152], [-22, 153], [-23, 154], [-24, 155], [-25, 156], [-26, 157], [-27, 158], [-28, 159], [-29, 160], [-30, 161], [-31, 162], [-32, 163], [-33, 164], [-34, 165], [-35, 166], [-36, 167], [-37, 168], [-38, 169], [-39, 170], [-40, 171], [-41, 172], [-42, 173], [-43, 174], [-44, 175], [-44, 180], [-44, 185], [-44, 190], [-44, 195], [-44, 200], [-44, 205], [-44, 210], [-44, 215], [-44, 220], [-44, 225], [-44, 230], [-44, 235], [-44, 240], [-44, 245], [-44, 250], [-44, 255], [-44, 260], [-44, 265], [-44, 270], [-44, 275], [-44, 280], [-44, 285], [-44, 290], [-44, 295], [-44, 300], [-44, 305], [-44, 310], [-44, 315], [-44, 320], [-44, 325], [-44, 330], [-44, 335], [-44, 340], [-44, 345], [-44, 350], [-44, 355], [-44, 360]],
    // Asia — Indonesia archipelago (major islands)
    [[6, 95], [5, 96], [4, 97], [3, 98], [2, 99], [1, 100], [0, 101], [-1, 102], [-2, 103], [-3, 104], [-4, 105], [-5, 106], [-6, 107], [-7, 108], [-8, 109], [-9, 110], [-10, 111], [-11, 112]],
  ];

  const mat = new THREE.LineBasicMaterial({ color: 0x0ea5e9, transparent: true, opacity: 0.18 });

  boundaries.forEach(boundary => {
    if (boundary.length < 2) return;
    const pts = boundary.map(pt => latLonToVector3(pt[0], pt[1], radius));
...
function initGlobe() {
  ...
  // Wireframe overlay
  const wireGeo = new THREE.SphereGeometry(R + 0.3, 32, 32);
  ...
  // Lat/lon grid lines (longitudes)
  for (let lon = -180; lon <= 180; lon += 30) {
    const pts = [];
    for (let lat = -90; lat <= 90; lat += 3) {
      pts.push(latLonToVector3(lat, lon, R + 0.5));
    }
    const geo = new THREE.BufferGeometry().setFromPoints(pts);
    const mat = new THREE.LineBasicMaterial({ color: 0x1e3a5f, transparent: true, opacity: 0.15 });
  ...
  for (let lat = -60; lat <= 60; lat += 30) {
    ...
    const geo = new THREE.BufferGeometry().setFromPoints(pts);
    const mat = new THREE.LineBasicMaterial({ color: 0x1e3a5f, transparent: true, opacity: 0.12 });
    globeGroup.add(new THREE.Line(geo, mat));
  }

  // Country boundary wireframe approximations (simplified continental outlines)
